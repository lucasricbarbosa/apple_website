      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="flex-center flex-col gap-5 sm:px-10">
            <div className="relative flex h-[50vh] w-full items-center overflow-hidden rounded-lg">
              <video
                playsInline
                id="exploreVideo"
            ...
            <div className="relative flex w-full flex-col">
              <div className="feature-video-container">
                <div className="h-[50vh] flex-1 overflow-hidden rounded-lg">
                  <img
                    src={explore1Img}
                    alt="Titanium"
                ...
                <div className="flex-center flex-1">
                  <p className="feature-text g_text">
                    ...
                    <span className="text-white">
                      the first iPhone to fit an aerospace-grade titanium design
                    </span>
